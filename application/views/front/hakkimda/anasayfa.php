...
if (@$_COOKIE['deneme']) {
    ...
    set_cookie('deneme', 'deneme', time() + 360);
...
<head>
    ...
    <meta conten="Rifai kuçi, Bilgisayar Mühendisliği, Mardin, Yazılım mühendisi, android" name="keywords">

    <meta content="1997 Mardin doğumluyum 5 yaşından beri Fatih İstanbul'da yaşıyorum.
     2016 yılında Mehmet Akif Ersoy Üniversitesinde (MAKÜ)  Bilgisayar mühendisliği bölümüne başlayarak yeni bir serüvene başlamış oldum .
     Bu yeni serüvenle beraber artık gelişen teknolojilere ilgim arttı, okuduğum bölüm gereği de popüler olan uygulamalar ve araçları
     sadece kullanmak yerine acaba bunlar nasıl yapılıyor merakı başladı. " name="description">
