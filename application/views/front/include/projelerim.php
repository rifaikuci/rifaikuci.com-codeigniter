<section id="projelerim" class="blog-mf sect-pt4 route">
    <div class="container">
        ...
        <div class="row">
            <?php foreach (anaproje() as $anaproje) { ?>
                <div class="col-md-4">
                    <div class="card card-blog">
                        <div class="card-img">

                            <a href="<?php
                            echo base_url('anasayfa/projedetay/');
                            echo $anaproje['seobaslik']; ?>">
                                <img src="<?php echo $anaproje['resim'] ?>" alt="<?php echo $anaproje['baslik'] ?>"
                                     class="img-fluid">
                            </a>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            echo $anaproje['seobaslik']; ?>">
                                <h2 class="card-title">
                                    <?php echo word_limiter($anaproje['baslik'], 3) ?>
                                </h2>
                            </a>

                            <p class="card-description">
                                <?php echo word_limiter($anaproje['icerik'], 15) ?>
                            </p>
                        </div>
