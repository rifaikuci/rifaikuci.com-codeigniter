                ...
                <div class="box-shadow-full">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-sm-6 col-md-5">
                                    ...
                                    <div class="about-img">
                                        ...
                                        <img alt="<?php echo $siteayar['adsoyad']; ?>"
                                             src="<?php echo $siteayar['resim']; ?>"
                            ...
                            <div>
                                <h1 class="title-left">Bilgilerim</h1>
                            </div>
                            <br>

                            <p>
                                <span class="title-s">Ad Soyad: </span>
                                <span><?php echo $siteayar['adsoyad']; ?></span>
                            </p>

                            <p>
                                <span class="title-s">Bölüm: </span>
                                <span><?php echo $siteayar['ozellik']; ?></span>
                            </p>

                            <p>
                                <span class="title-s">Email: </span>
                                <a href="mailto:rifaikuci@gmail.com?Subject=rifaikuci.com%20Adresinden" target="_top">
                                    <span><?php echo $siteayar['mail']; ?></span>
                                </a>
                            </p>
                            ...
                            <div class="socials">
                                ...
                                <ul>
                                    ...
                                    <?php foreach (smedyaion() as $smedya) { ?>
                                        <li style="margin-top:20px">
                                            <a target="_blank" href="<?php echo $smedya ['url']; ?>">
                                                <span class="ico-circle">
                                                    <i class="ion-social-<?php echo $smedya['seoAd']; ?>"></i>
                                                </span>
                                            </a>
                                        </li>
                                    <?php } ?>
                                    ...
                                    <li style="margin-top:20px">
                                        <a target="_blank"
                                           href="mailto:rifaikuci@gmail.com?Subject=rifaikuci.com%20Adresinden">
                                            <span class="ico-circle"><i class="ion-email"></i></span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
