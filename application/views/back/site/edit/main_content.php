<section class="content">
    <div class="col-md-12">
        ...
        <div class="box box-info">
            ...
            <form action="<?php echo base_url('yonetim/siteguncelle'); ?>" enctype="multipart/form-data" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <img style="width:160px; height:160px; margin-left:50px;"
                                 src="<?php echo base_url() . $bilgi['resim']; ?>" alt="Site Ön Panel Resmi"
                                 name="resim"/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input required type="text" name="footerLink" class="form-control"
                                   value="<?php echo $bilgi['footerLink']; ?>">
                        </div>
                    </div>
