    ...
    <section class="content">
      <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <form action="<?php echo base_url('yonetim/siteekleme'); ?>" enctype="multipart/form-data"  method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Başlık </label>
                    <div class="col-sm-10">
                    <input required type="text" name="baslik" class="form-control"  placeholder="Başlık Giriniz... ">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Özellik </label>
                    <div class="col-sm-10">
                    <input required type="text" name="ozellik" class="form-control"  placeholder="Özellik Giriniz... ">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Telefon </label>
                    <div class="col-sm-10">
                    <input required type="text" name="telefon" class="form-control"  placeholder="Telefon Giriniz... ">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Adres </label>
                    <div class="col-sm-10">
                    <input required type="text" name="adres" class="form-control"  placeholder="Adres Giriniz... ">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Footer Ad </label>
                    <div class="col-sm-10">
                    <input required type="text" name="footerAd" class="form-control"  placeholder="Footer Adı  Giriniz... ">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Footer Link  </label>
                    <div class="col-sm-10">
                    <input required type="text" name="footerLink" class="form-control"  placeholder="Footer Linki Giriniz... ">
                  </div>
                </div>
