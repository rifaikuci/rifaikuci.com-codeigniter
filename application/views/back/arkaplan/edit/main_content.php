    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Arka Plan Güncelleme Formu</h3>
            </div>

            <form action="<?php echo base_url('yonetim/arkaplanguncelle'); ?>" enctype="multipart/form-data"
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <img style="width:384px; height:211px; margin-left:50px;"
                                 src="<?php echo base_url() . $bilgi['resim']; ?>" alt="Arka Plan Resim" name="resim">
                        </div>
                    </div>
