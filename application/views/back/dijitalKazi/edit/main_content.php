              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Kazı Adı </label>
                    <div class="col-sm-10">
                    <input required type="text" name="kAdi" class="form-control"
                           value="<?php echo $bilgi['kAdi']; ?>"/>

                    <input required type="hidden" name="kId" class="form-control"
                           value="<?php echo $bilgi['kId']; ?>"/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Kazı Adresi </label>
                    <div class="col-sm-10">
                    <input required type="text" name="kAdres" class="form-control"
                           value="<?php echo $bilgi['kAdres']; ?>"/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Başlama Tarihi</label>
                    <div class="col-sm-4">
                    <input  type="date" name="kBasTarih" class="form-control"
                            value="<?php echo date('Y-m-d',strtotime($bilgi['kBasTarih'])) ?>"/>
                  </div>

                  <label style="margin-left:-40px" class="col-sm-2 control-label">Bitiş Tarihi </label>
                    <div class="col-sm-4">
                    <input  type="date" name="kBitTarih" class="form-control"
                            value="<?php echo date('Y-m-d',strtotime($bilgi['kBitTarih'])) ?>" >
                  </div>
                </div>
