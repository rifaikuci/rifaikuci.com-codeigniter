      ...
      <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Sosyal Medaya Hesap Güncelleme Formu</h3>
            </div>

            <form action="<?php echo base_url('yonetim/smedyaguncelle'); ?>" method="post" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Sosyal M. Hesap Adı</label>
                    <div class="col-sm-6">
                    <input required type="text" name="ad" class="form-control" value="<?php echo $bilgi['ad']; ?>" >
              ...
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Url </label>
                    <div class="col-sm-6">
                    <input required type="text" name="url" class="form-control" value="<?php echo $bilgi['url']; ?>" >
