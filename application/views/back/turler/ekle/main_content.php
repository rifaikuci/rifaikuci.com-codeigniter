<section class="content">
    <div class="col-md-12">
        ...
        <div class="box box-info">
            ...
            <form action="<?php echo base_url('yonetim/turlerekleme'); ?>" enctype="multipart/form-data" method="post"
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input required type="text" name="turEnlem" class="form-control"
                                   placeholder="Enlem Bilgisi Giriniz..." ">

                        </div>

                        <label class="col-sm-2 control-label">Boylam </label>
                        <div class="col-sm-4">
                            <input required type="text" name="turBoylam" class="form-control"
                                   placeholder="Boylam Bilgisi Giriniz..." ">
                        </div>
                    </div>
