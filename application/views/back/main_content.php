              ...
              <ul class="products-list product-list-in-box">
                ...
                <li class="item">
                  <div class="product-img">
                    <img src="<?php echo base_url(); echo $adminhit['resim']; ?>" alt="Product Image">
                  </div>
                  <div class="product-info">
                  <?php
                  if($adminhit['type']=="proje"){
                   ?>
                    <a href="<?php echo base_url('yonetim/projelerduzenle/'.$adminhit['id'].''); ?>" class="product-title"><?php echo $adminhit['baslik']; ?>
<?php }else {?>
    <a href="<?php echo base_url('yonetim/yazilarduzenle/'.$adminhit['id'].''); ?>" class="product-title"><?php echo $adminhit['baslik']; ?>
    <?php } ?>

                      <span class="label label-warning pull-right"><?php echo $adminhit['hit']; ?></span></a>
...
<div style="text-align:center">
            ...
            <div class="box-body">
              <ul class="products-list product-list-in-box">
                ...
                <?php
                $anayazilar=anayazilar();
                 foreach ($anayazilar as $anayazilar): ?>

                 <a href="<?php echo base_url('yonetim/yazilarduzenle/'.$anayazilar['id'].''); ?>">
                <li class="item">
                  <div class="product-img">
                    <img src="<?php echo base_url(); echo $anayazilar['resim']; ?>" alt="Product Image">
                  </div>
                  <div class="product-info">
                    <a href="<?php echo base_url('yonetim/yazilarduzenle/'.$anayazilar['id'].''); ?>" class="product-title"><?php echo $anayazilar['baslik']; ?>
...
<div class="box box-primary">
  ...
  <div class="box-body">
    <ul class="products-list product-list-in-box">
      ...
      <?php
      $proje=anaproje();
       foreach ($proje as $proje): ?>

<a href="<?php echo base_url('yonetim/projelerduzenle/'.$proje['id'].''); ?>">
      <li class="item">

        <div class="product-img">
          <img src="<?php echo base_url(); echo $proje['resim']; ?>" alt="Product Image">
        </div>
        <div class="product-info">
          <a href="<?php echo base_url('yonetim/projelerduzenle/'.$proje['id'].''); ?>" class="product-title"><?php echo $proje['baslik']; ?>
