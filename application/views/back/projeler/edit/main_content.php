      ...
      <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Proje Güncelleme Formu</h3>
            </div>

            <form action="<?php echo base_url('yonetim/projelerguncelle'); ?>" enctype="multipart/form-data"  method="post" class="form-horizontal">
              <div class="box-body">
                  ...
                  <label class="col-sm-2 control-label">Kategoriler </label>
                    <div class="col-sm-10">
                      <select  class="form-control" required name="idkategori">
                        <?php $bilgim= kategoriliste(); foreach ($bilgim as $bilgim) {
                            if ($bilgim['id']== $bilgi['idkategori']){ ?>
                            <option selected value="<?php  echo $bilgim['id']; ?>"><?php  echo $bilgim['ad']; ?></option>
                            <?php  }else { ?>
                              <option  value="<?php  echo $bilgim['id']; ?>"><?php  echo $bilgim['ad']; ?></option>
                          <?php   } }?>
