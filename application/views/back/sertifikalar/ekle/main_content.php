    ...
    <section class="content">
      <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <form action="<?php echo base_url('yonetim/sertifikalarekleme'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Sertifika Adı</label>
                    <div class="col-sm-6">
                    <input required type="text" name="sertifika" class="form-control"  placeholder="Sertifika Adı ... ">
                  </div>
                </div>
