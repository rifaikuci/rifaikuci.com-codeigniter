<section class="content">
    <div class="col-md-12">
        ...
        <div class="box box-info">
            ...
            <form action="<?php echo base_url('yonetim/sertifikalarguncelle'); ?>" enctype="multipart/form-data"
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input required type="text" name="sertifika" class="form-control"
                                   value="<?php echo $bilgi['sertifika']; ?>" placeholder="Sertifika Adı">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <img style="width:500px; height:320px; " src="<?php echo base_url() . $bilgi['resim']; ?>"
                                 alt="Sertifika Resim" name="resim">
                        </div>
                ...
                <div class="box-footer">
                    <a class="btn btn-warning fa fa-close" href="<?php echo base_url('yonetim/sertifikalar') ?>">
                        Vazgeç</a>
