    ...
    <section class="content">
      <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <form action="<?php echo base_url('yonetim/adminguncelle'); ?>" enctype="multipart/form-data"  method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Site URL </label>
                    <div class="col-sm-10">
                    <input required type="text" name="site_url" class="form-control"  value="<?php echo $bilgi['site_url']; ?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Site Adı </label>
                    <div class="col-sm-10">
                    <input required type="text" name="site_adi" class="form-control"  value="<?php echo $bilgi['site_adi']; ?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Version </label>
                    <div class="col-sm-10">
                    <input required type="text" name="version" class="form-control"  value="<?php echo $bilgi['version']; ?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"> Mevcud Resim</label>
                    <div class="col-sm-4">
                    <img  style="width:160px; height:160px; margin-left:50px;" src="<?php echo base_url().$bilgi['resim']; ?>" alt="Yazarın Resmi" name="resim">
                  </div>
