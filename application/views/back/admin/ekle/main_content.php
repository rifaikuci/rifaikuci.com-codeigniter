    ...
    <section class="content">
      <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <form action="<?php echo base_url('yonetim/adminekleme'); ?>" enctype="multipart/form-data"  method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Site URL </label>
                    <div class="col-sm-10">
                    <input required type="text" name="site_url" class="form-control"  placeholder="Site URL Giriniz... ">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Site Adı </label>
                    <div class="col-sm-10">
                    <input required type="text" name="site_adi" class="form-control"  placeholder="Site Adı Giriniz... ">
                  </div>
                </div>
