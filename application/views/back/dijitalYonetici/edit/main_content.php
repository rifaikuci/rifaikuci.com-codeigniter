    ...
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Yönetici Güncelleme</h3>
            </div>

            <form action="<?php echo base_url('yonetim/dijitalYoneticiguncelle'); ?>" enctype="multipart/form-data"
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input required type="text" name="yName" class="form-control"
                                   value="<?php echo $bilgi['yName']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input required type="text" name="yEmail" class="form-control"
                                   value="<?php echo $bilgi['yEmail']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input required type="text" name="yRfid" class="form-control" disabled
                                   value="<?php echo $bilgi['yRfid']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <img style="width:160px; height:160px; margin-left:50px;"
                                 src="<?php echo $bilgi['yFoto']; ?>" alt="Yönetici Resmi"
                                 name="<?php echo $bilgi['yName']; ?>">
                        </div>
        ...
        <div class="box-footer">
            <a class="btn btn-warning fa fa-close" href="<?php echo base_url('yonetim/dijitalYonetici') ?>"> Vazgeç</a>
