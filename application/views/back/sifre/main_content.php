              ...
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Mail Adresinizi  Giriniz</label>
                    <div class="col-sm-6">
                    <input required type="mail" name="email" class="form-control"   placeholder="mail Adresinizi Giriniz ... ">
                    <input required type="hidden" name="id" class="form-control" value="<?php echo $idg; ?>"  placeholder="mail Adresinizi Giriniz ... ">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Eski Şifrenizi Giriniz</label>
                    <div class="col-sm-6">
                    <input required type="password" name="sifre" class="form-control" value=""  placeholder="Eski Şifrenizi Giriniz ... ">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Yeni Şifrenizi Giriniz</label>
                    <div class="col-sm-6">
                    <input required type="password" name="sifre1" class="form-control"  value="" placeholder="Yeni Şifrenizi Giriniz... ">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Yeni Şifrenizi Tekrar  Giriniz</label>
                    <div class="col-sm-6">
                    <input required type="password" name="sifre2" class="form-control" value=""  placeholder="Yeni Şifrenizi Tekrar Giriniz.">
