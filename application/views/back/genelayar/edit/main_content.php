<section class="content">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <form action="<?php echo base_url('yonetim/genelayarguncelle'); ?>" enctype="multipart/form-data"
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input required type="text" name="logotitle" class="form-control"
                                   value="<?php echo $bilgi['logotitle']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <img style="width:600px; height:400px; " src="<?php echo base_url() . $bilgi['resim']; ?>"
                                 alt="Arka Plan Resmi Resmi" name="resim">
                        </div>
                    </div>
