...
<div class="wrapper">
    <title>RifaiKuçi | GRA Veri Girişi</title>
    <?php $this->load->view('back/include/header.php'); ?>
    <?php $this->load->view('back/include/sidebar.php'); ?>

    <div class="content-wrapper">
        <?php $this->load->view('back/bulanik/bulanikVeri/breadcrumb.php'); ?>
        <?php $this->load->view('back/bulanik/bulanikVeri/main_content.php'); ?>
    </div>
