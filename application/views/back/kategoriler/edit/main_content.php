          ...
          <div class="box box-info">
            ...
            <form action="<?php echo base_url('yonetim/kategorilerguncelle'); ?>" method="post" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Kategori Adı</label>
                    <div class="col-sm-6">
                    <input required type="text" name="ad" class="form-control" value="<?php echo $bilgi['ad']; ?>" placeholder="Kategori Adı">
              ...
              <div class="box-footer">
                <a class= "btn btn-warning fa fa-close" href="<?php echo base_url('yonetim/kategoriler') ?>"> Vazgeç</a>
