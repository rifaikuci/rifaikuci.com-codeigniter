    ...
    <section class="content">
      <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <form action="<?php echo base_url('yonetim/duyurularekleme'); ?>" enctype="multipart/form-data"  method="post" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Duyuru </label>
                    <div class="col-sm-10">
                    <input required type="text" name="duyuruBaslik" class="form-control"  placeholder="Duyuru giriniz... ">
                  </div>
                </div>
