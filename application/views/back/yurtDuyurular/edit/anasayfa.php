...
<div class="wrapper">
    <title>RifaiKuçi | Akıllı Yurt & Duyurular Güncelleme</title>
...
<?php $this->load->view('back/yurtDuyurular/edit/breadcrumb.php'); ?>

    <!-- Main content -->
<?php $this->load->view('back/yurtDuyurular/edit/main_content.php'); ?>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
