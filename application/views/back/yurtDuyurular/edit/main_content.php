<section class="content">
    <div class="col-md-12">
        ...
        <div class="box box-info">
            ...
            <form action="<?php echo base_url('yonetim/duyurularguncelle'); ?>" enctype="multipart/form-data"
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input required type="text" name="duyuruBaslik" class="form-control"
                                   value="<?php echo $bilgi['duyuruBaslik']; ?>">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="duyuruDetay" id="editor1" rows="8"
                                          style="width: 100%"><?php echo $bilgi['duyuruDetay']; ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input disabled type="text" class="form-control"
                                   value="<?php echo tarih($bilgi['duyuruTarih']); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="duyuruVideo" class="form-control"
                                   value="<?php echo $bilgi['duyuruVideo']; ?>">
                        </div>
                    </div>
                </div>
