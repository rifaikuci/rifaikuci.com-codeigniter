    ...
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">İcon Güncelleme Formu</h3>
            </div>

            <form action="<?php echo base_url('yonetim/iconguncelle'); ?>" enctype="multipart/form-data" method="post"
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <img style="width:128px; height:128px; margin-left:50px;"
                                 src="<?php echo base_url() . $bilgi['resim']; ?>" alt="Üst Logo Resim" name="resim">
                        </div>
