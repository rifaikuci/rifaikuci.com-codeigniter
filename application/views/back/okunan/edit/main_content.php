<section class="content">
    <div class="col-md-12">
        ...
        <div class="box box-info">
            ...
            <form action="<?php echo base_url('yonetim/okunanguncelle'); ?>" enctype="multipart/form-data" method="post"
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="date" name="baslatarihi" class="form-control"
                                   value="<?php echo date('Y-m-d', strtotime($bilgi['baslatarihi'])) ?>">
                        </div>

                        <label style="margin-left:-40px" class="col-sm-2 control-label">Bitiş Tarihi </label>
                        <div class="col-sm-4">
                            <input type="date" name="bitistarihi"
                                   value="<?php echo date('Y-m-d', strtotime($bilgi['bitistarihi'])) ?>"
                                   class="form-control">
                        </div>
                    </div>
                    ...
                    <div style="margin-top:50px" class="form-group">
                        ...
                        <div class="col-sm-4">
                            <img height="281" width="179" src="<?php echo base_url();
                            echo $bilgi['resim']; ?>" alt="<?php echo $bilgi['kitapadi']; ?>">
                        </div>
