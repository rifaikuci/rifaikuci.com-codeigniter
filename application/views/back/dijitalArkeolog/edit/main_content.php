    ...
    <section class="content">
      <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <form action="<?php echo base_url('yonetim/dijitalArkeologguncelle'); ?>" enctype="multipart/form-data"  method="post" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Ad Soyad </label>
                    <div class="col-sm-10">
                    <input required type="text" name="aName" class="form-control"  value="<?php echo $bilgi['aName']; ?>">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"> Mevcud Resim</label>
                    <div class="col-sm-4">
                    <img style="width:160px; height:160px; margin-left:50px;" src="<?php echo  base_url("/").$bilgi['aPhoto']; ?>" alt="Arkeolog Resmi" name="aPhoto">
                  </div>
                ...
                <div class="box-body">
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Mail </label>
                      <div class="col-sm-4">
                      <input required type="text" name="aEmail" class="form-control"  value="<?php echo $bilgi['aEmail']; ?>">
                    </div>

                    <label class="col-sm-2 control-label">Telefon </label>
                      <div class="col-sm-4">
                      <input required type="text" name="aPhone" class="form-control"  value="<?php echo $bilgi['aPhone']; ?>">
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <label class="col-sm-2 control-label">Kayıt Tarihi </label>
                    ...
                    value=" <?php $tarih =$bilgi['aDateSave'];
                    $tarih = explode(" ", $tarih);
