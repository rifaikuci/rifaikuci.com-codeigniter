...
<div class="wrapper">
<title>Arkeolog Güncelleme</title>
...
<?php $this->load->view('back/dijitalArkeolog/edit/breadcrumb.php'); ?>

    <!-- Main content -->
<?php $this->load->view('back/dijitalArkeolog/edit/main_content.php'); ?>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
