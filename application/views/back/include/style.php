    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/back'); ?>/dist/css/kendim.css">
    ...
    <link rel="stylesheet" href="<?php echo base_url(''); ?>/ckeditor/plugins/codesnippet/lib/highlight/styles/monokai.css" />
