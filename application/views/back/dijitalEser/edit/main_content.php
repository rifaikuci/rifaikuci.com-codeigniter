            ...
            <form action="<?php echo base_url('yonetim/dijitalEserguncelle'); ?>" method="post" class="form-horizontal">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input required type="text" name="eBaslik" class="form-control"
                                   value="<?php echo $bilgi['eBaslik']; ?>"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input required type="text" name="eRfid" disabled class="form-control"
                                   value="<?php echo $bilgi['eRfid']; ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input required type="text" name="eEnvanter" class="form-control"
                                   value="<?php echo $bilgi['eEnvanter']; ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input required type="text" name="eKonum" class="form-control" disabled
                                   value="<?php echo $bilgi['eKonum']; ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input required type="text" disabled name="eKayitTarih" class="form-control"
                                   value=" <?php echo tarih($bilgi['eKayitTarih']); ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea required type="text" rows="8" name="eBilgi" class="form-control" value="">
                                <?php echo $bilgi['eBilgi']; ?>
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <img style="width:160px; height:160px; margin-left:50px;"
                                 src="<?php echo base_url("/") . $bilgi['eFoto']; ?>" alt="Eserler Resmi" name="eFoto">
                        </div>
                            ...
                            <div class="col-sm-4">
                                <?php if ($bilgi['eQR'] == null) { ?>
                                    <a href="<?php echo base_url('yonetim/dijitalQrKod/' . $bilgi['eId'] . '/' . $bilgi['eRfid'] . ''); ?>">
                                        <button style="margin-top:50px;" type="button" name='button'
                                                class="btn btn-info">Qr Kodu Oluşturunuz
                                        </button>
                                    </a>
                                ...
                                <?php } else { ?>
                                    ...
                                    <img style="width:160px; height:160px; margin-left:50px;"
                                         src="<?php echo base_url('/') . $bilgi['eQR']; ?>" alt="Qr Kod  Resmi"
                                         name="eQR">
