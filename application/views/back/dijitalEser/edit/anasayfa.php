...
<div class="wrapper">
<title>Eserler Güncelleme Ayarları</title>
...
<?php $this->load->view('back/dijitalEser/edit/breadcrumb.php'); ?>

    <!-- Main content -->
<?php $this->load->view('back/dijitalEser/edit/main_content.php'); ?>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
