    ...
    <section class="content">
      <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <form action="<?php echo base_url('yonetim/gununsozuguncelle'); ?>" enctype="multipart/form-data"  method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="box-body">
                  ...
                  <label class="col-sm-2 control-label">Ad Soyad </label>
                    <div class="col-sm-10">
                    <input required type="text" name="gununsozu" class="form-control"  value="<?php echo $bilgi['gununsozu']; ?>">
